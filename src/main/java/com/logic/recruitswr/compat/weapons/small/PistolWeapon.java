...
public class PistolWeapon extends WariumWeapon {

    public PistolWeapon() {
        super(CrustyChunksModItems.SEMI_AUTOMATIC_PISTOL_ANIMATED.get());
    ...
    public int getMaxAmmo() {
        return RecruitsWariumConfig.MAX_PISTOL_AMMO.get();
    }
    ...
    public double getBaseWeaponInaccuracy() {
        return RecruitsWariumConfig.PISTOL_INACCURACY.get();
    }

    @Override
    public int getAttackCooldown() {
        return RecruitsWariumConfig.MAX_PISTOL_COOLDOWN.get();
    }

    @Override
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_PISTOL_RELOAD.get();
    }
