...
public class MachineCarbineWeapon extends WariumWeapon {

    public MachineCarbineWeapon() {
        super(CrustyChunksModItems.MACHINE_CARBINE.get());
    ...
    public int getMaxAmmo() {
        return RecruitsWariumConfig.MAX_MACHINE_CARBINE_AMMO.get();
    }
    ...
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_MACHINE_CARBINE_RELOAD.get();
    }
