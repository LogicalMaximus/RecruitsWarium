...
public class ScopedBreechRifleWeapon extends WariumWeapon {
    ...
    public int getMaxAmmo() {
        return RecruitsWariumConfig.MAX_BREECH_RIFLE_AMMO.get();
    }
    ...
    protected void playShootSounds(Level world, BlockPos pos) {
        CrustyChunksMod.queueServerWork(1, () -> {
            if (!world.isClientSide()) {
                world.playSound((Player)null, pos, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:tinyexplosionfar")), SoundSource.NEUTRAL, 15.0F, (float)Mth.nextDouble(RandomSource.create(), 0.7, 0.8));
                world.playSound((Player)null, pos, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:autocannonshot")), SoundSource.NEUTRAL, 15.0F, (float)Mth.nextDouble(RandomSource.create(), 0.7, 0.8));
                world.playSound((Player)null, pos, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:largeshot")), SoundSource.NEUTRAL, 15.0F, (float)Mth.nextDouble(RandomSource.create(), 0.7, 0.8));
            } else {
                world.playLocalSound(pos, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:tinyexplosionfar")), SoundSource.NEUTRAL, 15.0F, (float)Mth.nextDouble(RandomSource.create(), 0.7, 0.8), false);
                world.playLocalSound(pos, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:autocannonshot")), SoundSource.NEUTRAL, 15.0F, (float)Mth.nextDouble(RandomSource.create(), 0.7, 0.8), false);
    ...
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_BREECH_RIFLE_RELOAD.get();
    }
