...
public class SemiAutomaticRifleWeapon extends WariumWeapon {

    public SemiAutomaticRifleWeapon() {
        super(CrustyChunksModItems.SEMI_AUTOMATIC_RIFLE_ANIMATED.get());
    ...
    public int getMaxAmmo() {
        return RecruitsWariumConfig.MAX_SEMI_AUTOMATIC_RIFLE_AMMO.get();
    }
    ...
    public double getBaseWeaponInaccuracy() {
        return RecruitsWariumConfig.SEMI_AUTOMATIC_RIFLE_INACCURACY.get();
    }

    @Override
    public int getAttackCooldown() {
        return RecruitsWariumConfig.MAX_SEMI_AUTOMATIC_RIFLE_COOLDOWN.get();
    }

    @Override
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_SEMI_AUTOMATIC_RIFLE_RELOAD.get();
    }
