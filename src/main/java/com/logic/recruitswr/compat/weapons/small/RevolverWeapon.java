...
public class RevolverWeapon extends WariumWeapon {

    public RevolverWeapon() {
        super(CrustyChunksModItems.REVOLVER_ANIMATED.get());
    ...
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_REVOLVER_RELOAD.get();
    }
    ...
    public SoundEvent getLoadSound() {
        return CrustyChunksModSounds.REVOLVERRELOAD.get();
    }
}
