...
public class PumpActionShotgunWeapon extends WariumWeapon {
    public PumpActionShotgunWeapon() {
        super(CrustyChunksModItems.PUMP_ACTION_SHOTGUN_ANIMATED.get());
    ...
    public int getMaxAmmo() {
        return RecruitsWariumConfig.MAX_PUMP_ACTION_SHOTGUN_AMMO.get();
    }

    @Override
    protected void playShootSounds(Level world, BlockPos pos) {
        RecruitsWariumSoundUtils.playShotgunSounds(world, pos);
    }

    @Override
    public int getAttackCooldown() {
        return RecruitsWariumConfig.MAX_PUMP_ACTION_SHOTGUN_COOLDOWN.get();
    }

    @Override
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_PUMP_ACTION_SHOTGUN_RELOAD.get();
    }
