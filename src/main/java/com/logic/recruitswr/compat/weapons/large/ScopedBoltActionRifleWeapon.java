...
public class ScopedBoltActionRifleWeapon extends WariumWeapon {
    public ScopedBoltActionRifleWeapon() {
        super(CrustyChunksModItems.BOLT_ACTION_RIFLE_ANIMATED.get());
    ...
    public int getMaxAmmo() {
        return RecruitsWariumConfig.MAX_BOLT_ACTION_RIFLE_AMMO.get();
    }

    @Override
    protected void playShootSounds(Level world, BlockPos pos) {
        RecruitsWariumSoundUtils.playLargeRifleSounds(world, pos);
    }
    ...
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_BOLT_ACTION_RIFLE_RELOAD.get();
    }
