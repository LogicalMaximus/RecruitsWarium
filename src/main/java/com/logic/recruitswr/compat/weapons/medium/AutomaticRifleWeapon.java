...
public class AutomaticRifleWeapon extends WariumWeapon {
    public AutomaticRifleWeapon() {
        super(CrustyChunksModItems.AUTOMATIC_RIFLE.get());
    ...
    public int getMaxAmmo() {
        return RecruitsWariumConfig.MAX_AUTOMATIC_RIFLE_AMMO.get();
    }
    ...
    public int getAttackCooldown() {
        return RecruitsWariumConfig.MAX_AUTOMATIC_RIFLE_COOLDOWN.get();
    }

    @Override
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_AUTOMATIC_RIFLE_RELOAD.get();
    }
