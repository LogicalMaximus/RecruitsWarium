...
public class SubmachineGunWeapon extends WariumWeapon {

    public SubmachineGunWeapon() {
        super(CrustyChunksModItems.SMG_ANIMATED.get());
    ...
    public int getMaxAmmo() {
        return RecruitsWariumConfig.MAX_SUBMACHINEGUN_AMMO.get();
    }
    ...
    public int getWeaponLoadTime() {
        return RecruitsWariumConfig.MAX_SUBMACHINEGUN_RELOAD.get();
    }
