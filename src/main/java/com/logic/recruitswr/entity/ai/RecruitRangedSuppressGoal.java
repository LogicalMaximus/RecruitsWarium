    ...
    public void tick() {
        if (this.target != null && this.target.isAlive()) {
            ...
            if(RecruitsWariumConfig.REALISTIC_LOOK_CONTROL.get()) {
                this.recruit.getLookControl().setLookAt(lookTarget.x, lookTarget.y, lookTarget.z, 120.0F, 180.0F);
            } else {
                this.recruit.lookAt(EntityAnchorArgument.Anchor.EYES, lookTarget);
            }
