...
public class RecruitPanicGoal extends Goal {
    ...
    public RecruitPanicGoal(AbstractRecruitEntity recruit, double p_25692_) {
        this.mob = recruit;
    ...
    protected boolean shouldPanic() {
        if(((ISuppressiveFire)this.mob).getMoraleState() == MoralState.CONFUSED || ((ISuppressiveFire)this.mob).getMoraleState() == MoralState.LOW_MORALE) {
            return this.mob.getTarget() != null && this.mob.getRandom().nextDouble() < RecruitsWariumConfig.RECRUIT_PANIC_CHANCE.get();
        }
