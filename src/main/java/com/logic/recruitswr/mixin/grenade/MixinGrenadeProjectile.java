...
@Mixin(GrenadeProjectileEntity.class)
public abstract class MixinGrenadeProjectile extends AbstractArrow implements ItemSupplier {

    protected MixinGrenadeProjectile(EntityType<? extends AbstractArrow> p_36721_, Level p_36722_) {
