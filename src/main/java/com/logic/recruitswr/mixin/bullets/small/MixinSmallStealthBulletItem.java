...
@Mixin(SmallStealthBulletItem.class)
public abstract class MixinSmallStealthBulletItem extends Item implements IAmmo {

    public MixinSmallStealthBulletItem(Properties p_41383_) {
        super(p_41383_);
    }

    @Override
    public EntityType<? extends AbstractArrow> getProjecile() {
        return CrustyChunksModEntities.SMALL_BULLET_STEALTH.get();
    }
