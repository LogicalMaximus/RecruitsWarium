...
public class RecruitsWariumConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> AUTOMATIC_RIFLE_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> AUTO_PISTOL_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> STEALTH_PISTOL_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> REVOLVER_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> SUBMACHINEGUN_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> MACHINE_CARBINE_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> LEVER_ACTION_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> SEMI_AUTOMATIC_RIFLE_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> MAX_BURST_RIFLE_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> LIGHT_MACHINE_GUN_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> BATTLE_RIFLE_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> GRENADE_COOLDOWN;

    public static final ForgeConfigSpec.ConfigValue<Integer> MAX_BOLT_ACTION_RIFLE_RELOAD;

    public static final ForgeConfigSpec.ConfigValue<Double> BOLT_ACTION_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> BREAK_ACTION_SHOTGUN_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> PUMP_ACTION_SHOTGUN_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> ANTI_MATERIAL_RIFLE_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> FLAME_THROWER_INACCURACY;

    public static final ForgeConfigSpec.ConfigValue<Float> BULLET_INACCURACY;
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> RECRUIT_FLEE_MORALE;

    public static final ForgeConfigSpec.ConfigValue<Float> RECRUIT_POSE_CHANCE;

    public static final ForgeConfigSpec.ConfigValue<Float> RECRUIT_PANIC_CHANCE;

    public static final ForgeConfigSpec.ConfigValue<Double> RECRUIT_FLEE_CHANCE;

    public static final ForgeConfigSpec.ConfigValue<Integer> RECRUIT_FLEE_TIME;

    public static final ForgeConfigSpec.ConfigValue<Double> RECRUIT_GRENADE_THROW_CHANCE;
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> LOW_MORALE_INACCURACY;

    public static final ForgeConfigSpec.ConfigValue<Double> CONFUSED_INACCURACY;

    public static final ForgeConfigSpec.ConfigValue<Boolean> SHOULD_MERCENARIES_SPAWN;

    public static final ForgeConfigSpec.ConfigValue<Boolean> SHOULD_RECRUITS_THROW_GRENADES;

    public static final ForgeConfigSpec.ConfigValue<Integer> RECRUIT_GRENADE_THROW_DELAY;

    public static final ForgeConfigSpec.ConfigValue<Double> STRATEGIC_FIRE_INACCURACY;

    public static final ForgeConfigSpec.ConfigValue<Double> SUPPRESSION_INACCURACY;

    public static final ForgeConfigSpec.ConfigValue<Integer> BULLET_SUPPRESSION_RADIUS;

    public static final ForgeConfigSpec.ConfigValue<Float> MORALE_SUPPRESSION_LOSS;

    public static final ForgeConfigSpec.ConfigValue<Float> BASE_INACCURACY;

    public static final ForgeConfigSpec.ConfigValue<Float> ACCURACY_GAIN_PER_LEVEL;
    ...
    static {
        ...
        AUTOMATIC_RIFLE_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Automatic Rifle For The Recruits In Radians\n\t(takes effect after restart)").define("AutomaticRifleInaccuracy", 0.5);
        ...
        AUTO_PISTOL_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Automatic Pistol For The Recruits In Radians\n\t(takes effect after restart)").define("AutomaticPistolInaccuracy", 0.5);
        ...
        PISTOL_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Pistol For The Recruits In Radians\n\t(takes effect after restart)").define("PistolInaccuracy", 0.5);
        ...
        STEALTH_PISTOL_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Stealth Pistol For The Recruits In Radians\n\t(takes effect after restart)").define("StealthPistolInaccuracy", 0.5);
        ...
        REVOLVER_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Revolver For The Recruits In Radians\n\t(takes effect after restart)").define("RevolverInaccuracy", 0.5);
        ...
        SUBMACHINEGUN_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Sub Machine Gun For The Recruits In Radians\n\t(takes effect after restart)").define("SubMachineGunInaccuracy", 0.5);
        ...
        MACHINE_CARBINE_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Machine Carbine For The Recruits In Radians\n\t(takes effect after restart)").define("MachineCarbineInaccuracy", 0.5);
        ...
        LEVER_ACTION_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Lever Action For The Recruits In Radians\n\t(takes effect after restart)").define("LeverActionInaccuracy", 0.5);
        ...
        SEMI_AUTOMATIC_RIFLE_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For Semi-Automatic Rifle For The Recruits In Radians\n\t(takes effect after restart)").define("SemiAutomaticRifleInaccuracy", 0.5);
        ...
        MAX_BURST_RIFLE_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Burst Rifle For The Recruits In Radians\n\t(takes effect after restart)").define("BurstRifleInaccuracy", 0.5);
        ...
        LIGHT_MACHINE_GUN_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Light Machine Gun For The Recruits In Radians\n\t(takes effect after restart)").define("LightMachineGunInaccuracy", 0.5);
        ...
        BATTLE_RIFLE_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Battle Rifle For The Recruits In Radians\n\t(takes effect after restart)").define("BattleRifleInaccuracy", 0.5);
        ...
        BOLT_ACTION_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Bolt Action Rifle For The Recruits In Radians\n\t(takes effect after restart)").define("BoltActionRifleInaccuracy", 0.5);
        ...
        BREAK_ACTION_SHOTGUN_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Break Action Shotgun For The Recruits In Radians\n\t(takes effect after restart)").define("BreakActionShotgunInaccuracy", 0.5);
        ...
        PUMP_ACTION_SHOTGUN_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Pump Action Shotgun For The Recruits In Radians\n\t(takes effect after restart)").define("PumpActionShotgunInaccuracy", 0.5);
        ...
        ANTI_MATERIAL_RIFLE_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Anti-Material Rifle For The Recruits In Radians\n\t(takes effect after restart)").define("AntiMaterialRifleInaccuracy", 0.5);
        ...
        FLAME_THROWER_INACCURACY = BUILDER.comment("\nThe Base Inaccuracy For The Flame Thrower For The Recruits In Radians\n\t(takes effect after restart)").define("FlameThrowerInaccuracy", 0.5);
        ...
        SHOULD_RECRUITS_THROW_GRENADES = BUILDER.comment("\nShould Recruits Have The Abilty To Throw Grenades \n\t(takes effect after restart)").define("ShouldRecruitsThrowGrenades", true);
        ...
        RECRUIT_PANIC_CHANCE = BUILDER.comment("\n The Chance At Which A Recruit Will Panic When They Have Really Low Morale \n\t(takes effect after restart)").define("RecruitPanicChance", 0.05F);

        RECRUIT_FLEE_MORALE = BUILDER.comment("\n How Low Does A Recruit's Morale Have To GetFor Them To Begin To Flee \n\t(takes effect after restart)").define("RecruitFleeMorale", 10);

        RECRUIT_FLEE_CHANCE = BUILDER.comment("\n The Chance That A Recruit Will Begin To Flee \n\t(takes effect after restart)").define("RecruitFleeChance", 0.15);

        RECRUIT_FLEE_TIME = BUILDER.comment("\n The Amount Of Time A Recruit Should Flee For In Ticks \n\t(takes effect after restart)").define("RecruitFleeTime", 120);

        LOW_MORALE_INACCURACY = BUILDER.comment("\n Inaccuracy Multiplier When Recruit Has Low Morale \n\t(takes effect after restart)").define("RecruitLowMoraleInaccuracy", 1.8);

        CONFUSED_INACCURACY = BUILDER.comment("\n Inaccuracy Multiplier When Recruit Has Is Confused AKA Extremely Low Morale \n\t(takes effect after restart)").define("RecruitLowMoraleInaccuracy", 2.5);

        BUILDER.pop();
        BUILDER.comment("Recruits Behaviour").push("Suppression");

        STRATEGIC_FIRE_INACCURACY = BUILDER.comment("\nStrategic Fire Inaccuracy Added To The Recruit's Aim So They Have A Wider Spread \n\t(takes effect after restart)").define("StrategicFireAimInaccuracy", 0.5);

        SUPPRESSION_INACCURACY = BUILDER.comment("\nSuppressive Fire Inaccuracy Added To The Recruit's Aim So They Can Effectively Suppress A Wide Area \n\t(takes effect after restart)").define("SuppressiveFireInaccuracy", 4.0);
        ...
        MORALE_SUPPRESSION_LOSS = BUILDER.comment("\nHow Much Morale A Recruit Lose From Suppression \n\t(takes effect after restart)").define("MoraleSuppressionLoss", 0.5F);

        BUILDER.pop();
        BUILDER.comment("Recruits Behaviour").push("Accuracy");

        BASE_INACCURACY = BUILDER.comment("\nBase Recruit Inaccuracy In Radians \n\t(takes effect after restart)").define("BaseRecruitInaccuracy", 2.5F);

        ACCURACY_GAIN_PER_LEVEL = BUILDER.comment("\nHow Much A Recruit's Accuracy Improves Per Level \n\t(takes effect after restart)").define("RecruitAccuracyGainPerLevel", 0.25F);
